...
<section class="background1" id="beginning">
    ...
    <section class="feed">
        <div class="navbar">
            ...
            <a href="index.php" class="hvr-sweep-to-bottom hvr-sweep-to-bottom-right">Log out</a>
            <a href="account.php" class="hvr-sweep-to-bottom hvr-sweep-to-bottom-right">My account</a>
        </div>
        ...
        <div class="hvr-grow-rotate">
            <div class="header">
                ...
                echo '<table>';
                echo '<tr>'; // Start of the first row

                // Output first 5 pairs (left side)
                foreach (array_slice($data, 0, 5) as $pair => $price) {
                    echo "<td>$pair: $price</td>";
                }

                echo '</tr><tr>'; // End of the first row and start of the second row

                // Output next 5 pairs (right side)
                foreach (array_slice($data, 5, 5) as $pair => $price) {
                    echo "<td>$pair: $price</td>";
                }

                echo '</tr>'; // End of the second row
                echo '</table>';
                ?>
            </div>
        </div>
        ...
        <div class="feedContent">
            <img src="assets/reklama.png" class="reklama">
            <!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8">
            ...
            <form id="quiz-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div id="question-container" class="quiz">
                    ...
                    <div class="question" id="question1">
                        ...
                        <br class="radio-label"><input type="radio" name="question1" value="3"> a) Invested in all the meme coins myself</br>
                        <br class="radio-label"><input type="radio" name="question1" value="0"> b) I keep money only at home and drive a Skoda estate</br>
                        <br class="radio-label"><input type="radio" name="question1" value="1"> c) Investing can only be done in Bitcoin</br>
                        <br class="radio-label"><input type="radio" name="question1" value="2"> d) Sometimes altcoins deserve attention</br>
                    </div>
                ...
                <input type="submit" id="submit-btn" value="Submit" style="submit">
            </form>
